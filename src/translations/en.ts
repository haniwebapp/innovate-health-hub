export const enTranslations = {
  ...
  'home.about.videoDuration': '2:45',
    ...
    'home.journey.title': 'Your Journey with the Innovation Platform',
    'home.journey.description': 'We provide a structured pathway for innovators to develop their solutions from idea to implementation.',
    'home.journey.ideation.title': 'Ideation',
    'home.journey.ideation.description': 'Identify healthcare challenges and develop innovative ideas for potential solutions.',
    'home.journey.development.title': 'Development',
    'home.journey.development.description': 'Transform ideas into working prototypes with expert support and guidance.',
    'home.journey.validation.title': 'Validation',
    'home.journey.validation.description': 'Test and validate solutions with healthcare professionals and end-users.',
    'home.journey.implementation.title': 'Implementation',
    'home.journey.implementation.description': 'Deploy solutions in real-world healthcare settings with ongoing support.',
    'home.journey.impact.title': 'Impact',
    'home.journey.impact.description': 'Measure outcomes and scale successful solutions across the healthcare system.',
    
    // Process Flow Section
    'home.process.tag': 'Innovation Process',
    'home.process.title': 'How Our Platform Works',
    'home.process.description': 'A streamlined process connecting healthcare innovators with opportunities, resources, and support.',
    'home.process.step1.title': 'Create Account',
    'home.process.step1.description': 'Register and complete your profile for a personalized platform experience.',
    'home.process.step2.title': 'Submit Innovation',
    'home.process.step2.description': 'Upload your idea or project using our submission form.',
    'home.process.step3.title': 'Get Feedback',
    'home.process.step3.description': 'Receive feedback from MOH experts and industry professionals.',
    'home.process.step4.title': 'Connect to Opportunities',
    'home.process.step4.description': 'Get matched with relevant investors, challenges, and resources.',
    'home.process.step5.title': 'Develop & Scale',
    'home.process.step5.description': 'Access ongoing support to develop and scale your innovation.',
    'home.process.buttonText': 'Start Innovation Journey',
  ...
  'healthcare.title.revolutionizing': 'Revolutionizing',
  'healthcare.title.healthcareInnovation': 'Healthcare Innovation',
  'healthcare.title.with': 'with',
  'healthcare.description': 'Our platform connects innovators, healthcare providers, and patients to create a healthier future for all through technology, collaboration, and breakthrough innovations.',
  'healthcare.stat1.label': 'Improved Outcomes',
  'healthcare.stat1.value': '87%',
  'healthcare.stat1.increase': '14.0%',
  'healthcare.stat2.label': 'Innovation Success',
  'healthcare.stat2.value': '92%',
  'healthcare.stat2.increase': '7.0%',
  'healthcare.stat3.label': 'Patient Satisfaction',
  'healthcare.stat3.value': '96%',
  'healthcare.stat3.increase': '5.0%',
  'healthcare.stat4.label': 'Cost Reduction',
  'healthcare.stat4.value': '41%',
  'healthcare.stat4.increase': '6.0%',
  'healthcare.button.explore': 'Explore Healthcare Solutions',
  'healthcare.label.dataActivity': 'Data Activity',
};
