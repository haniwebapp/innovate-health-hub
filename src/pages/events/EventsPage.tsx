...
export default function EventsPage() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-moh-lightGreen/20 relative overflow-hidden">
          ...
          >
            ...
            <div className="flex justify-center gap-4 flex-wrap">
              ...
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.98 }}
                className="bg-white text-moh-green border border-moh-green px-6 py-2.5 rounded-md font-medium hover:bg-moh-green/5 transition-colors"
              >
