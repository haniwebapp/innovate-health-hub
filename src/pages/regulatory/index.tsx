...
export default function RegulatoryPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-[#e6f7f0] via-white to-[#e6f7f0]">
      <Navbar />
      <ScrollProgress />
      
      <main className="flex-grow pt-0 my-0 rounded-none py-0">
        {/* Hero Section */}
        <section className="relative overflow-hidden bg-gradient-to-br from-[#00814A] via-[#006e3f] to-[#00814A] text-white">
          {/* Background decoration elements */}
          <div className="absolute inset-0 opacity-10">
            <div className="absolute top-20 left-10 w-72 h-72 rounded-full bg-[#C3A86B] blur-3xl"></div>
            <div className="absolute bottom-10 right-10 w-80 h-80 rounded-full bg-[#d5c193] blur-3xl"></div>
            <div className="absolute top-40 right-20 w-60 h-60 rounded-full bg-[#00602e] blur-3xl"></div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              ...
              >
                <motion.span 
                  ...
                  className="inline-block px-3 py-1 rounded-full bg-[#00602e] text-[#e6f7f0] text-sm font-medium"
                >
                  Regulatory Hub
                </motion.span>
                ...
                >
                  Healthcare <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#C3A86B] to-[#d5c193]">Regulatory Sandbox</span>
                </motion.h1>
                
                <motion.p 
                  className="text-lg md:text-xl text-[#e6f7f0]"
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
                ...
                >
                  <a href="#ai-analyzer" className="bg-[#C3A86B] hover:bg-[#b39559] text-white font-medium py-3 px-6 rounded-lg flex items-center justify-center">
                    Start Compliance Check
                    <ChevronRight className="ml-2 h-4 w-4" />
                  </a>
                  <a href="#frameworks" className="border border-[#C3A86B]/50 text-[#d5c193] hover:bg-[#00602e]/20 font-medium py-3 px-6 rounded-lg flex items-center justify-center">
                    View Frameworks
                  </a>
                </motion.div>
              </motion.div>
              ...
              >
                <div className="relative">
                  <div className="absolute -top-10 -left-10 w-20 h-20 bg-[#C3A86B]/20 rounded-full blur-md"></div>
                  <div className="absolute -bottom-5 -right-5 w-16 h-16 bg-[#C3A86B]/30 rounded-full blur-md"></div>
                  
                  <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl p-6 relative">
                    <div className="flex items-center justify-between mb-4">
                      <div className="flex items-center">
                        <div className="w-10 h-10 rounded-full bg-[#00814A] flex items-center justify-center">
                    ...
                    <div className="space-y-3">
                      ...
                      >
                        <div className="flex items-center">
                          <div className="w-8 h-8 rounded-full bg-[#00814A]/30 flex items-center justify-center mr-3">
                            <ClipboardCheck className="h-4 w-4 text-white" />
                          </div>
                          <div>
                            <p className="font-medium text-white">Medical Device Standards</p>
                            <div className="flex mt-1">
                              <span className="text-xs bg-[#00814A]/20 text-white px-2 py-0.5 rounded">5 steps</span>
                      ...
                      >
                        <div className="flex items-center">
                          ...
                          <div>
                            ...
                            <div className="flex mt-1">
                              <span className="text-xs bg-[#00814A]/20 text-white px-2 py-0.5 rounded">6 steps</span>
                    ...
                    <div className="mt-4 text-center">
                      <a href="#frameworks" className="text-[#d5c193] hover:text-[#C3A86B] text-sm flex items-center justify-center">
                        View all frameworks
          ...
          <div className="absolute bottom-0 left-0 w-full overflow-hidden">
            <svg viewBox="0 0 1200 120" preserveAspectRatio="none" className="relative block w-full h-12">
              <path d="M321.39,56.44c58-10.79,114.16-30.13,172-41.86,82.39-16.72,168.19-17.73,250.45-.39C823.78,31,906.67,72,985.66,92.83c70.05,18.48,146.53,26.09,214.34,3V120H0V95.8C59.71,118.92,130.83,141.41,214.86,114.72,271.78,97.31,328.1,64.46,392.73,38.81" fill="currentColor" className="text-[#e6f7f0]"></path>
            </svg>
          </div>
        </section>
          ...
          <div className="max-w-5xl mx-auto">
            <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-8">
              <div className="flex justify-center">
                <TabsList className="bg-[#e6f7f0]">
                  <TabsTrigger 
                    value="overview" 
                    className="px-6 data-[state=active]:bg-[#00814A] data-[state=active]:text-white"
                  >
                    Overview
                  </TabsTrigger>
                  <TabsTrigger 
              ...
              <TabsContent value="overview">
                {/* AI Compliance Analyzer - Moved above the OverviewTab content */}
                <div id="ai-analyzer" className="mb-8">
                  <h2 className="text-2xl font-semibold mb-6 text-[#00814A]">AI Compliance Assessment</h2>
              ...
              <TabsContent value="frameworks">
                <h2 className="text-2xl font-semibold mb-6 text-[#00814A]">Regulatory Frameworks</h2>
            ...
            {/* Remove duplicate FAQ section here as it's already included in OverviewTab */}
          </div>
        </div>
      </main>
