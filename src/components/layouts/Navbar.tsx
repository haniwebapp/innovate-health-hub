  ...
  return <header className="fixed top-0 left-0 right-0 z-50 bg-white/90 backdrop-blur-sm shadow-sm">
        ...
        <div className="flex justify-between items-center h-16">
          <div className="flex items-center">
            <Link to="/" className="flex items-center">
              <img src="/public/lovable-uploads/90b8f7e1-a93b-49bc-9fd6-06a4beeff4e6.png" alt="Ministry of Health Logo" className="h-10 w-auto object-contain" />
      ...
      {mobileMenuOpen && <div className="md:hidden bg-white shadow-lg">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            <Link to="/about" className="block px-3 py-2 rounded-md text-base font-medium text-moh-darkGreen hover:bg-moh-lightGreen" onClick={() => setMobileMenuOpen(false)}>
              About
            </Link>
            <Link to="/challenges" className="block px-3 py-2 rounded-md text-base font-medium text-moh-darkGreen hover:bg-moh-lightGreen" onClick={() => setMobileMenuOpen(false)}>
              Challenges
            </Link>
            <Link to="/innovations" className="block px-3 py-2 rounded-md text-base font-medium text-moh-darkGreen hover:bg-moh-lightGreen" onClick={() => setMobileMenuOpen(false)}>
              Innovations
            </Link>
            <Link to="/knowledge-hub" className="block px-3 py-2 rounded-md text-base font-medium text-moh-darkGreen hover:bg-moh-lightGreen" onClick={() => setMobileMenuOpen(false)}>
              Knowledge Hub
            </Link>
