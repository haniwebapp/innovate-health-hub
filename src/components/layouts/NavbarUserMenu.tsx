      ...
      {user ? (
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="w-56 bg-white">
            ...
            <DropdownMenuSeparator />
            <DropdownMenuItem onClick={() => navigate('/dashboard')} className="hover:bg-gray-50 hover:text-moh-green">
              Dashboard
            </DropdownMenuItem>
            <DropdownMenuItem onClick={() => navigate('/dashboard/profile')} className="hover:bg-gray-50 hover:text-moh-green">
              Profile Settings
            </DropdownMenuItem>
            <DropdownMenuItem onClick={() => navigate('/dashboard/submissions')} className="hover:bg-gray-50 hover:text-moh-green">
              My Submissions
            </DropdownMenuItem>
            {isAdmin && (
              <>
                ...
                <DropdownMenuItem onClick={() => navigate('/dashboard/create-challenge')} className="hover:bg-gray-50 hover:text-moh-green">
                  Create Challenge
                </DropdownMenuItem>
                <DropdownMenuItem onClick={() => navigate('/dashboard/analytics')} className="hover:bg-gray-50 hover:text-moh-green">
                  Analytics Dashboard
                </DropdownMenuItem>
              </>
            )}
            <DropdownMenuSeparator />
            <DropdownMenuItem 
              className="text-red-600 focus:text-red-600 hover:bg-red-50 flex items-center"
