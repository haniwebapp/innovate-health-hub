...
export default function Footer() {
  ...
  return <footer className="bg-moh-darkGreen text-white relative overflow-hidden">
      <motion.div
        className="absolute inset-0 bg-[url('/pattern.svg')] opacity-10 bg-repeat z-0"
        initial={{ opacity: 0 }}
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <ScrollFadeIn direction="up" delay={0.3}>
            ...
            >
              {[
                'footer.aboutPlatform',
                'footer.innovationChallenges',
                'footer.investmentOpportunities',
                'footer.regulatorySandbox',
                'footer.knowledgeHub'
              ].map((linkKey, i) => (
                <motion.li 
                  key={i}
                ...
                >
                  <motion.a 
                    href="#" 
                    className="text-gray-300 hover:text-white inline-block relative"
                    whileHover={{
                      color: "#ffffff",
          ...
          <ScrollFadeIn direction="up" delay={0.7}>
            ...
            <div className="flex gap-2">
              <Input 
                ...
                className="bg-white/20 border-white/10 text-white placeholder:text-gray-400 focus:ring-moh-gold focus:border-moh-gold transition-all" 
              />
            ...
            <motion.div
              className="mt-6 p-4 rounded-md bg-white/10 border border-white/20"
        ...
        <motion.div 
          className="border-t border-white/10 mt-8 pt-8 flex flex-col md:flex-row justify-between"
          initial={{ opacity: 0 }}
