        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <ScrollFadeIn direction="up" delay={0.3}>
            ...
            once: true
              ...
              {['footer.aboutPlatform', 'footer.innovationChallenges', 'footer.investmentOpportunities', 'footer.regulatorySandbox', 'footer.knowledgeHub'].map((linkKey, i) => <motion.li key={i} variants={{
              hidden: {
                opacity: 0,
                x: -10
              },
          ...
          <ScrollFadeIn direction="up" delay={0.5}>
            ...
            once: true
              ...
              {['footer.vision2030', 'footer.mohStrategy', 'footer.policies', 'footer.successStories', 'footer.contactSupport'].map((linkKey, i) => <motion.li key={i} variants={{
              hidden: {
                opacity: 0,
                x: -10
              },
          ...
          <ScrollFadeIn direction="up" delay={0.7}>
            ...
            <div className="flex gap-2">
              <Input type="email" placeholder={t('footer.emailPlaceholder')} className="bg-white/20 border-white/10 text-white placeholder:text-gray-400 focus:ring-moh-gold focus:border-moh-gold transition-all" />
