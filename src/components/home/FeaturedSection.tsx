...
export default function FeaturedSection() {
  ...
  const stats: Stat[] = [{
    value: 325,
    labelKey: "home.featured.stats.innovators",
    suffix: "+"
  }, {
    value: 42,
    labelKey: "home.featured.stats.investments",
    suffix: "M"
  }, {
    value: 18,
    labelKey: "home.featured.stats.launched",
    suffix: ""
  }, {
    value: 95,
    labelKey: "home.featured.stats.success",
    suffix: "%"
  }];
        ...
        <div ref={statsRef} className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16">
          {stats.map((stat, index) => <ScrollFadeIn key={index} delay={0.2 * index} className="text-center group">
            ...
            transition: {
              ...
              <p className="text-gray-600 mt-2 my-[37px]">{t(stat.labelKey)}</p>
                      ...
                      <CardContent className="p-0">
                        <div className="grid md:grid-cols-2 gap-0">
                          <div className="h-64 md:h-auto overflow-hidden">
                            <motion.img src={story.image} alt={t(story.titleKey)} className="w-full h-full object-cover" whileHover={{
                          scale: 1.05
                        }} transition={{
                          duration: 0.5
                        }} />
